...
{
	static uint32_t irow = 0;
	static int32_t x2 = 90, x1 = 120, y1 = 80, xn1, yn1, xn2, yn2, r;
	static double theta1 = sinea, theta2 = sineb, theta3 = sinec;
	static double ra, si, co;

	double t1 = 3.0 * q1, t2 = 2.0 * q2, t3 = 2.0 * q3, t4 = 1.0 * q0;

	OledMoveTo(60 + t1, 40 + t4);
	OledLineTo(180 - t1, 40 + t4);
	OledLineTo(180 - t1, 115 - t4);
	OledMoveTo(60 + t1, 40 + t4);
	OledLineTo(60 + t1, 115 - t4);
	OledLineTo(180 - t1, 115 - t4);

	OledMoveTo(80 + t3, 70 + t2);
	OledLineTo(160 - t3, 70 + t2);
	OledLineTo(160 - t3, 80 - t2);
	OledMoveTo(80 + t3, 70 + t2);
	OledLineTo(80 + t3, 80 - t2);
	OledLineTo(160 - t3, 80 - t2);
