...
${OBJECTDIR}/_ext/60163342/plib_adc2.o: ../src/config/default/peripheral/adc/plib_adc2.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/config/default/peripheral/adc/plib_adc2.c  -o ${OBJECTDIR}/_ext/60163342/plib_adc2.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/60163342/plib_adc2.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD5=1    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -ffunction-sections -fdata-sections -fno-short-double -msmall-code -msmall-data -msmall-scalar -mconst-in-code -O3 -I"../src" -I"../src/config/default" -Werror -Wall -msmart-io=1 -msfr-warn=off -finline  -mdfp="${DFP_DIR}/xc32"
...
${OBJECTDIR}/_ext/60178257/plib_ptg.o: ../src/config/default/peripheral/ptg/plib_ptg.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/_ext/60178257" 
	@${RM} ${OBJECTDIR}/_ext/60178257/plib_ptg.o.d 
	@${RM} ${OBJECTDIR}/_ext/60178257/plib_ptg.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/config/default/peripheral/ptg/plib_ptg.c  -o ${OBJECTDIR}/_ext/60178257/plib_ptg.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/60178257/plib_ptg.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD5=1    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -ffunction-sections -fdata-sections -fno-short-double -msmall-code -msmall-data -msmall-scalar -mconst-in-code -O3 -I"../src" -I"../src/config/default" -Werror -Wall -msmart-io=1 -msfr-warn=off -finline  -mdfp="${DFP_DIR}/xc32"
	@${FIXDEPS} "${OBJECTDIR}/_ext/60178257/plib_ptg.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/60184501/plib_wdt.o: ../src/config/default/peripheral/wdt/plib_wdt.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/config/default/peripheral/wdt/plib_wdt.c  -o ${OBJECTDIR}/_ext/60184501/plib_wdt.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/60184501/plib_wdt.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD5=1    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -ffunction-sections -fdata-sections -fno-short-double -msmall-code -msmall-data -msmall-scalar -mconst-in-code -O3 -I"../src" -I"../src/config/default" -Werror -Wall -msmart-io=1 -msfr-warn=off -finline  -mdfp="${DFP_DIR}/xc32"
	@${FIXDEPS} "${OBJECTDIR}/_ext/60184501/plib_wdt.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${DISTDIR}/analog_fe.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o ${DISTDIR}/analog_fe.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG=__DEBUG -D__MPLAB_DEBUGGER_ICD5=1  -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)      -Wl,,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D__DEBUG=__DEBUG,--defsym=__MPLAB_DEBUGGER_ICD5=1,$(MP_LINKER_FILE_OPTION),--heap=0,--data-init,--isr,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,${DISTDIR}/memoryfile.xml$(MP_EXTRA_LD_POST) -mdfp="${DFP_DIR}/xc32" 
	
else
${DISTDIR}/analog_fe.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o ${DISTDIR}/analog_fe.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -Wl,,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--heap=0,--data-init,--isr,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,${DISTDIR}/memoryfile.xml$(MP_EXTRA_LD_POST) -mdfp="${DFP_DIR}/xc32" 
